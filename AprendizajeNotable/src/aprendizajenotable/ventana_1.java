...
public class ventana_1 extends JFrame implements ActionListener {
    ...
    public ventana_1(String titulo, int ancho, int alto) {
        setLayout(null);
        setTitle(titulo);
        setSize(ancho, alto);
        ...
        lblpregunta1 = new JLabel("¿Cuál de estas expresiones  ");
    ...
    public static void main(String[] args) {
        new ventana_1("nivel 1.1", 400, 300);
