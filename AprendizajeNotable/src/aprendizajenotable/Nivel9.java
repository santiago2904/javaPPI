...
public class Nivel9 extends JFrame implements ActionListener {
    ...
    public Nivel9(String titulo, int ancho, int alto) {
        ...
        lblpregunta = new JLabel("El resultado de (4x - 4)² es:");
        rdbtnop1 = new JRadioButton("16x² - 32x + 16");
        rdbtnop2 = new JRadioButton("-16x² + 32x – 16");
        rdbtnop3 = new JRadioButton("16x² + 32x – 16");
        rdbtnop4 = new JRadioButton("16x² - 32 - x");
