 ...
 * @author Lenovo
 */
public class Nivel4 extends JFrame implements ActionListener {
    ...
    public Nivel4(String titulo, int ancho, int alto) {
        setLayout(null);
        setTitle(titulo);
        setSize(ancho, alto);
        ...
        rdbtnop1 = new JRadioButton("(2a-3b)a²");
    ...
    public static void main(String[] args) {
        new Nivel4("Nivel 3 de Factorizacion de Trinomio ", 400, 300);
